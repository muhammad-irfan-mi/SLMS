...
const examSyllabusRoutes = require('./src/routes/syllabus.route');
...
const cashAccount = require('./src/routes/cashAccount.routes');
...
const studentFeeAssignmentRoutes = require("./src/routes/studentFeeStructure.routes");
...
app.use('/api/syllabus', examSyllabusRoutes);
...
app.use('/api/cashAccount', cashAccount);
